...
class _BookmarksHubScreenState extends ConsumerState<BookmarksHubScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: colors.background,
        title: Text(strings.bookmarksTitle),
        leading: IconButton(
          tooltip: 'Back',
                        ...
                        children: [
                          ...
                          PopupMenuButton<String>(
                            ...
                            itemBuilder: (context) => const [
                              PopupMenuItem(
                                  value: 'copy', child: Text(strings.copy)),
                              PopupMenuItem(
                                  value: 'note', child: Text(strings.note)),
                              PopupMenuItem(
                                  value: 'delete', child: Text(strings.delete)),
                            ],
                          ),
                        ],
                      ),
  ...
  Future<void> _openHadithBookmark(
    ...
    if (!ok || !db.isInitialized ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content:
                Text(strings.thatHadithNotBundled)),
      );
      return;
    }
    final books =
