...
class _ZakatCalculatorScreenState extends State<ZakatCalculatorScreen> {
  ...
  void _calculateZakat() {
    ...
    setState(() {
      _totalWealth = total;
      // FIX: Uncommented — now properly assigned
      ...
      } else if (_totalWealth < _nisabThreshold) {
        _zakatAmount = 0;
        _zakatDue = false;
        _nisabMessage = 'Your wealth is below Nisab threshold '
            '(${_formatAmount(_nisabThreshold)}). '
      ...
      child: Row(
        ...
        children: [
          Icon(
            ...
            color: _zakatDue ? const Color(0xFF00E676) : Colors.orange,
            size: 20,
          ),
          const SizedBox(width: 10),
          Expanded(
          ...
          children: _currencySymbols.keys.map((c) {
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color:
                      selected ? const Color(0xFF00E676) : Colors.transparent,
                  borderRadius: BorderRadius.circular(10),
                ),
                child: Text(
                  c,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (cash > 0)
            _breakdownRow('Cash & Bank', cash, const Color(0xFF00E676)),
          if (investment > 0)
          ...
          _breakdownRow('Total Wealth', _totalWealth, const Color(0xFF00E676)),
