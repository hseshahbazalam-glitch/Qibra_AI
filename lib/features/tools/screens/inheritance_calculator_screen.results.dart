        ...
        children: [
          ...
          if (_deceasedGender == 'female')
            _toggleRow('Husband', Icons.man_rounded, _hasHusband,
                (v) => _patchUi(() => _hasHusband = v), colors.primarySoft),
          if (_deceasedGender == 'male') ...[
            _toggleRow('Wife', Icons.woman_rounded, _hasWife,
                (v) => _patchUi(() => _hasWife = v), colors.accent),
            if (_hasWife)
              _counterRow('Number of Wives', _wifeCount, 1, 4,
                  (v) => _patchUi(() => _wifeCount = v), colors.accent),
          ],
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          _toggleRow('Father', Icons.man_rounded, _hasFather,
              (v) => _patchUi(() => _hasFather = v), colors.primary),
          _toggleRow('Mother', Icons.woman_rounded, _hasMother,
              (v) => _patchUi(() => _hasMother = v), colors.primarySoft),
          if (!_hasFather)
            _toggleRow('Grandfather', Icons.elderly_rounded, _hasGrandfather,
                (v) => _patchUi(() => _hasGrandfather = v), colors.primarySoft),
          if (!_hasMother)
            _toggleRow('Grandmother', Icons.elderly_rounded, _hasGrandmother,
                (v) => _patchUi(() => _hasGrandmother = v), colors.accent),
        ],
      ),
    );
  }
        ...
        children: [
          Text('Children & Grandchildren',
              style: TextStyle(
                  ...
                  fontWeight: FontWeight.w700)),
          const SizedBox(height: 10),
          _counterRow('Sons', _sons, 0, 20, (v) => _patchUi(() => _sons = v),
              colors.primarySoft),
          _counterRow('Daughters', _daughters, 0, 20,
              (v) => _patchUi(() => _daughters = v), colors.accent),
          if (_sons == 0 && _daughters == 0) ...[
            _counterRow('Grandsons', _grandsons, 0, 20,
                (v) => _patchUi(() => _grandsons = v), colors.primarySoft),
            _counterRow('Granddaughters', _granddaughters, 0, 20,
                (v) => _patchUi(() => _granddaughters = v), colors.accent),
          ],
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          _counterRow('Brothers', _brothers, 0, 20,
              (v) => _patchUi(() => _brothers = v), colors.primarySoft),
          _counterRow('Sisters', _sisters, 0, 20,
              (v) => _patchUi(() => _sisters = v), colors.accent),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          _counterRow(
              ...
              0,
              20,
              (v) => _patchUi(() => _halfBrothersFather = v),
              colors.primarySoft),
          ...
          _counterRow('Maternal Half Brothers', _halfBrothersMother, 0, 20,
              (v) => _patchUi(() => _halfBrothersMother = v), colors.accent),
          _counterRow('Maternal Half Sisters', _halfSistersMother, 0, 20,
              (v) => _patchUi(() => _halfSistersMother = v), colors.accent),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          ...
          _toggleRow('Paternal Uncle', Icons.man_rounded, _hasUncle,
              (v) => _patchUi(() => _hasUncle = v), colors.primarySoft),
        ],
      ),
    );
  }
