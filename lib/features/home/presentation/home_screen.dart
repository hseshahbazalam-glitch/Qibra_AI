...
// ============================================================
// QIBRA AI — HOME DASHBOARD (v21.0 — Layout Crash Fixed)
// ============================================================
...
class _HomeScreenState extends ConsumerState<HomeScreen>
  ...
  String _hijriMonthAbbr(int m) => const [
        'Muharram',
        'Safar',
        'Rabi I',
        'Rabi II',
  ...
  // ============================================================
  // HERO SECTION — mosque bg + greeting + next prayer overlay
  // ============================================================
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              mainAxisSize: MainAxisSize.min,
              children: [
                Text(locationName ?? 'Bangalore, India',
                    style: const TextStyle(
                        color: Colors.white,
                        fontSize: 10,
                        fontWeight: FontWeight.w700),
          ...
          Flexible(
            child: Text(
                '${HijriCalendar.fromDate(DateTime.now()).hDay} ${_hijriMonthAbbr(HijriCalendar.fromDate(DateTime.now()).hMonth)} ${HijriCalendar.fromDate(DateTime.now()).hYear} AH',
                style: TextStyle(
  ...
  // ============================================================
  // TODAY'S PROGRESS + PRAYER STREAK ROW
  // ============================================================
  ...
  Widget _buildContinueReadingCard() {
    ...
    final progress = ps.overallProgress > 0 ? ps.overallProgress : 0.35;
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Icon(Icons.arrow_forward_rounded,
                            color: Color(0xFF04231A), size: 13),
                      ],
                    ),
                  ),
                ],
  ...
  // ============================================================
  // DAILY VERSE + HADITH ROW  ✅ FIXED — wrapped in IntrinsicHeight
  // ============================================================
        ...
        Padding(
          ...
          child: IntrinsicHeight(
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: [
                const Expanded(child: _DailyVerseCard()),
                const SizedBox(width: 10),
                const Expanded(child: HomeHadithCard()),
              ],
            ),
          ),
        ),
  ...
  // ============================================================
  // RAMADAN + QIBLA + NEARBY MOSQUES ROW
  // ============================================================
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 3),
                        const Icon(Icons.arrow_forward_rounded,
                            color: Color(0xFFB794F6), size: 10),
                      ],
                    ),
                  ),
                ],
                      ...
                      RepaintBoundary(
                        child: CustomPaint(
                          ...
                          painter: _CircularProgressPainter(
                              progress: 1.0, color: const Color(0xFF00E676)),
                        ),
                      ),
...
// ============================================================
// ISOLATED: NEXT PRAYER OVERLAY CARD (prevents full-screen rebuild)
// ============================================================
...
class _NextPrayerOverlayCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final progress = 1.0 - (s / totalMax).clamp(0.0, 1.0);
                ...
                children: [
                  RepaintBoundary(
                    child: CustomPaint(
                      ...
                      painter: _CircularProgressPainter(
                          progress: progress, color: const Color(0xFF00E676)),
                    ),
                  ),
                  Column(
                    mainAxisSize: MainAxisSize.min,
            ...
            AnimatedBuilder(
              ...
              builder: (_, __) => Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: const Color(0xFF00E676)
                        .withValues(alpha: 0.4 + 0.3 * pulseController.value),
                    width: 1,
                  ),
                ),
                child: Row(
...
// ============================================================
// ISOLATED: TODAY'S PRAYER TIMES CARD (FIXED — uniform sizing)
// ============================================================
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // ✅ FIXED: All prayer cards now uniform — using IntrinsicHeight so
          // active card doesn't stretch others & fixed height ensures uniformity
          IntrinsicHeight(
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.stretch,
              children: List.generate(5, (i) {
                ...
                final time = prayers != null
                    ...
                    : defaultPrayers[i].$2;
                final isNext = nextType == type || (nextType == null && i == 0);

                return Expanded(
                  child: Padding(
                    padding: EdgeInsets.only(right: i == 4 ? 0 : 6),
                    child:
                        _PrayerMiniCard(type: type, time: time, isNext: isNext),
                  ),
                );
              }),
            ),
...
// ============================================================
// PRAYER MINI CARD — FIXED: uniform sizing, no text overflow
// ============================================================
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        // ✅ FIXED: consistent padding for all cards
        ...
        child: Column(
          ...
          children: [
            ...
            // Prayer name — uniform font size, FittedBox to prevent overflow
            FittedBox(
            ...
            // Time — uniform font size, FittedBox to prevent overflow
            FittedBox(
              fit: BoxFit.scaleDown,
              child: Text(
                time,
            ...
            // "Upcoming" badge — only for active card, no height difference issue
            // because IntrinsicHeight makes all cards match tallest one
            if (isNext) ...[
              const SizedBox(height: 4),
              FittedBox(
                fit: BoxFit.scaleDown,
...
// ============================================================
// ISOLATED: DAILY VERSE CARD (independent rebuild, ayah provider)
// ============================================================
...
// ============================================================
// STARS PAINTER WIDGET (wrapped for RepaintBoundary isolation)
// ============================================================
...
class _StarsPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final stars = [
      ...
      Offset(size.width * 0.4, size.height * 0.10),
      Offset(size.width * 0.55, size.height * 0.30),
      Offset(size.width * 0.7, size.height * 0.20),
