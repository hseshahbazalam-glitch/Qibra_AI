...
class VoiceService {
  ...
  // ============================================================
  // INITIALIZE — App start pe call karo
  // ============================================================
  ...
  Future<void> speak(String text, {String? language}) async {
    ...
    try {
      ...
      // Clean text for speaking (remove markdown, emojis, JSON)
